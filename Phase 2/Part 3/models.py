...
class FitwellFoodLog():
    def __init__(self, email, date_time, food_name, protein, carbs, fat, food_calories):
        food_log = {
            'email': email,
            'date_time': date_time,
            'food_name': food_name,
        ...
        db.foodlogs.insert_one(food_log)
